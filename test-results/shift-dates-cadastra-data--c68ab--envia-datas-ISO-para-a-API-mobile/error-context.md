...
- Name: shift-dates.spec.ts >> cadastra data e repeticao em formato brasileiro e envia datas ISO para a API
- Location: e2e\shift-dates.spec.ts:126:1
...
Call log:
  - waiting for getByRole('dialog').getByLabel('Repetir plantao')
    - locator resolved to <input name="repeat" type="checkbox"/>
  - attempting click action
    2 × waiting for element to be visible, enabled and stable
      - element is visible, enabled and stable
      - scrolling into view if needed
      - done scrolling
      - <select name="location_id">…</select> from <label class="field">…</label> subtree intercepts pointer events
  ...
  2 × retrying click action
      ...
      - scrolling into view if needed
      - done scrolling
      - <section class="modal" role="dialog" aria-modal="true">…</section> intercepts pointer events
        ...
        - generic [ref=e113]:
          ...
          - generic [ref=e115]:
            ...
            - generic "Escolher data no calendario" [ref=e117]:
              - textbox "Escolher data no calendario" [ref=e120] [cursor=pointer]: 2026-09-10
        - generic [ref=e121]:
...
```ts
  ...
  44  |     shiftCount: 3,
  45  |     shiftHours: 36,
  46  |     activeLocationCount: 1,
  47  |     nextReceivable: null,
  48  |   },
  49  | };
  50  | 
  51  | test.beforeEach(async ({ page }) => {
  52  |   await page.clock.setFixedTime(new Date("2026-09-09T01:30:00Z"));
  53  | 
  54  |   // Autenticacao e dados simulados: estes testes nunca gravam no Supabase.
  55  |   await page.route("**/auth/v1/**", (route) => route.fulfill({
  56  |     json: {
  57  |       access_token: "eyJhbGciOiJIUzI1NiJ9.eyJleHAiOjQxMDI0NDQ4MDB9.test-signature",
  58  |       refresh_token: "test-refresh-token",
